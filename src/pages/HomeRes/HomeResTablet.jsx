...
export const HomeResTable = () => {
  return (
    <div className="min-h-screen w-full bg-zinc-950">
      <div className="min-h-screen h-fit max-w-[1000px] mx-auto grid grid-cols-12 grid-rows-12 gap-5 p-10">
        {/* Hero Section - Large */}
        <div className="col-span-5 row-span-12 grid grid-cols-3 grid-rows-12 gap-4">
        ...
        {/* Skills - Medium */}
        <div className="col-span-7 row-span-12 grid grid-cols-3 grid-rows-11 gap-4">
        ...
        {/* Profile Image - Small */}
        <div className="col-span-12 row-span-12 grid grid-cols-5 grid-rows-12 gap-4">
